...
| **🧠 Radar Architectures & Topologies**| Examines monostatic, bistatic, multistatic, and phased array radar configurations.                                 | [View Folder](./Architecture)                 |
...
| **📍 Target Detection & Ranging**      | Algorithms and methods for detecting objects, measuring distance, speed, and angle of arrival.                     | [View Folder](./Detection)                     |
| **📊 Radar Performance Metrics**       | Includes radar cross section (RCS), SNR, detection probability, false alarms, and range resolution.                | [View Folder](./Performance)                   |
